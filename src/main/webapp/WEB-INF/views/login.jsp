...
.img:before {
	...
	height: 100%;
	background-image:
		url("http://localhost:8080/resources/image/login/login-section.jpg");
...
<div class="cont">
	<form action="${loginUrl}" method="post" class="form sign-in">
		<h2>Dobrodošao nazad,</h2>
		<c:if test="${param.error != null}">
			<p class="label label-danger login-error-custom">Neispravno
				korisničko ime ili šifra.</p>
		</c:if>
		<label> <span>Korisničko ime</span> <input type="text"
			name="username" required="required" />
		</label> <label> <span>Šifra</span> <input type="password"
			name="password" required="required" />
		</label> <label><input type="checkbox" id="rememberme"
			name="remember-me"> Remember Me</label>
		<p class="forgot-pass">Zobaravili ste šfiru?</p>
