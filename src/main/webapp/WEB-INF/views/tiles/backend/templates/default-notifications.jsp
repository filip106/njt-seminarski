...
<ul class="nav navbar-top-links navbar-right">
    <li class=""><a href="<c:url value='/' />"><i class="fa fa-globe"></i></a></li>
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-messages">
            ...
            <li class="divider"></li>
            <li>
                <a class="text-center" href="#"> <strong>Read All Messages</strong> <i
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-tasks">
            ...
            <li class="divider"></li>
            <li><a class="text-center" href="#"> <strong>See All Tasks</strong> <i class="fa fa-angle-right"></i></a>
            </li>
        </ul>
    </li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-user">
            <li><a href="#"><i class="fa fa-user fa-fw"></i> Korisnički Profil</a></li>
            <li><a href="<c:url value='/backend/general-settings' />"><i class="fa fa-gear fa-fw"></i> Podešavanja</a></li>
            <li class="divider"></li>
